...
for DIM in $DIM_list;do
    ...
    CUDA_VISIBLE_DEVICES=7   python train.py -data $DATA  -net vgg  -init orth  -lr 1e-5 -dim $DIM -alpha 16  -k 32   -BatchSize 64 -loss $loss  -epochs 501 -checkpoints $checkpoints -log_dir $loss/$DATA/$DIM  -save_step 50
    Model_LIST="0 50 100 150 200 250 300 400 500"
