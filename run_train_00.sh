...
for alpha in $alpha_list;do
    ...
    mkdir $l
    CUDA_VISIBLE_DEVICES=0,1,6,7  python train.py -data $DATA -BN  1  -init random -lr 3e-5 -dim $DIM -alpha $alpha -num_instances 5 -BatchSize 280 -loss $loss  -epochs 1801 -checkpoints $checkpoints -log_dir $l  -save_step 50
    Model_LIST="400 800 900 1000 1200 1400 1800"
