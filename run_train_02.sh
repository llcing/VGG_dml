...
for DATA in $DATA_list;do
    ...
    for DIM in $DIM_list;do
        ...
        CUDA_VISIBLE_DEVICES=7   python train.py -data $DATA  -net vgg  -init random -lr 1e-5 -dim $DIM  -num_instances 5 -BatchSize 70 -loss $loss  -epochs 1401 -checkpoints $checkpoints -log_dir $l  -save_step 50
        Model_LIST="200 400 500 700 800 900 1000 1200 1400"
