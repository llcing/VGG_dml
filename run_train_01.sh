...
for DIM in $DIM_list;do
    ...
    CUDA_VISIBLE_DEVICES=6   python train.py -data $DATA  -net vgg  -init random  -lr 1e-5 -dim $DIM -alpha 40 -num_instances 5 -BatchSize 70 -loss $loss  -epochs 141 -checkpoints $checkpoints  -log_dir $loss/$DATA/$DIM -save_step 5
