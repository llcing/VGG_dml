...
for DIM in $DIM_list;do
    ...
    CUDA_VISIBLE_DEVICES=6   python train.py -data $DATA  -net vgg  -init orth  -lr 1e-5 -dim $DIM -alpha 16  -k 32   -BatchSize 64 -loss $loss  -epochs 51 -checkpoints $checkpoints -log_dir $loss/$DATA/$DIM  -save_step 100
